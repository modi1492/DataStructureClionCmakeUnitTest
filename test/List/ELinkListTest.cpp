...
#include <util/util.h>
#include <util/EListUtil.h>
#include "basic/List/ELinkList/ELinkList.h"



TEST(ELinkList, ELinkListT) {
    ELinkList L;
    Link p, q, s;
    Position r;
    int i;
...
TEST(ELinkList, ELinkListMerge) {
    char s1[] = "/Users/chenmengdi/Documents/GitHub/DataStructureClionCmakeUnitTest/test/List/TestData_La.txt";
    char s2[] = "/Users/chenmengdi/Documents/GitHub/DataStructureClionCmakeUnitTest/test/List/TestData_Lb.txt";
    ELinkList La, Lb, Lc;

    printf("创建La和Lb以待测试...\n");

    CreateList_Tail(&La, s1);
    printf("La= ");
    ListTraverse(La, PrintElem);

    CreateList_Tail(&Lb, s2);
    printf("Lb= ");
